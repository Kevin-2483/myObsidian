# [数据类型](https://www.nushell.sh/zh-CN/book/types_of_data.html#数据类型)
...
## [整数](https://www.nushell.sh/zh-CN/book/types_of_data.html#整数)
...
## [小数](https://www.nushell.sh/zh-CN/book/types_of_data.html#小数)
...
## [字符串](https://www.nushell.sh/zh-CN/book/types_of_data.html#字符串)
...
## [文本行](https://www.nushell.sh/zh-CN/book/types_of_data.html#文本行)

文本行(Lines)是具有隐含的操作系统特定行结尾的字符串。使用时需要加上操作系统特定的行尾标识。

## [列路径](https://www.nushell.sh/zh-CN/book/types_of_data.html#列路径)

列路径(Column Paths)是指通过表格到特定子表、列、行或单元格的路径。

例如) `open data.toml | get foo.0.bar`中的值`foo.0.bar`

## [Glob 模式（通配符）](https://www.nushell.sh/zh-CN/book/types_of_data.html#glob-模式-通配符)
...
## [布尔类型](https://www.nushell.sh/zh-CN/book/types_of_data.html#布尔类型)

布尔类型是指真或假的状态。它通常用于一个比较的结果，而非直接使用该值。

布尔类型的两个值是`true`和`false`。

## [日期](https://www.nushell.sh/zh-CN/book/types_of_data.html#日期)
...
## [时间间隔](https://www.nushell.sh/zh-CN/book/types_of_data.html#时间间隔)
...
## [区间](https://www.nushell.sh/zh-CN/book/types_of_data.html#区间)

区间(Ranges)是一种表达从开始到结束的数值序列的方式。它们的形式是`'start' + '..' + 'end'`。例如，范围 `1..3`表示数字 1、2、和 3。

## [闭区间和开区间](https://www.nushell.sh/zh-CN/book/types_of_data.html#闭区间和开区间)
...
## [开放式区间](https://www.nushell.sh/zh-CN/book/types_of_data.html#开放式区间)
...
## [文件大小](https://www.nushell.sh/zh-CN/book/types_of_data.html#文件大小)
...
## [二进制数据](https://www.nushell.sh/zh-CN/book/types_of_data.html#二进制数据)
...
## [结构化数据](https://www.nushell.sh/zh-CN/book/types_of_data.html#结构化数据)

结构化数据是在简单数据的基础上建立的。例如，结构化数据给我们提供了一种在同一数值中表示多个整数的方法，而不是一个单一的整数。目前支持的结构化数据类型有：记录、列表和表格。

## [记录](https://www.nushell.sh/zh-CN/book/types_of_data.html#记录)
...
## [列表](https://www.nushell.sh/zh-CN/book/types_of_data.html#列表)
...
## [表](https://www.nushell.sh/zh-CN/book/types_of_data.html#表)
...
## [块](https://www.nushell.sh/zh-CN/book/types_of_data.html#块)
...
## [组](https://www.nushell.sh/zh-CN/book/types_of_data.html#组)
